...
def SCR_mode():
    ...
    def Engineering_handbook():
        ...
        print("3. Go back to the control pannel using 'e' ")
        print("4. Use 'o' to raise the control rods increasing steam pressure")
        print("5. Experiment and play with the other functions ")
        print(" ")
        print("             **CONTROLS**    ")
        print(" ")
        print("Remove control rod 10%: i ")
        print("Insert control rod 10%: o ")
    ...
    def Reactor_Start_Up():
        ...
        while KI < 2:
            ...
            print(Fore.WHITE + "---SCR SL Control Room---")
            print("")
            if MP == False:
                for i in range(6):
                    print("")
                ...
                print("Control rod withdrawal: ", CR1 ," %")
...
def MCR_mode():
    ...
    def Alert_Pop(x):
        ...
        ttk.Button(frm, text="Dismiss", command=root.destroy).grid(column=1, row=0)
